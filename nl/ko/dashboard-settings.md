...
이러한 기능을 사용하여 필요와 요구사항에 가장 적합하도록 {{site.data.keyword.composeForJanusGraph_full}} 서비스를 조정할 수 있습니다.
...
![버전 패널](./images/janusgraph-version-show.png "버전 패널")
...
2. _배치 세부사항_ 패널에서 **리소스 스케일링**을 클릭하십시오. 리소스 스케일링 페이지가 열립니다.
    ...
    ![리소스 스케일링 페이지](./images/janusgraph-scale-show.png "리소스 스케일링 페이지")

3. 슬라이더를 조정하여 {{site.data.keyword.composeForJanusGraph}} 서비스에 할당된 스토리지를 늘리거나 줄이십시오. 스토리지의 양을 줄이려면 슬라이더를 왼쪽으로 이동하고 스토리지를 늘리려면 오른쪽으로 이동하십시오.
4. **배치 스케일링**을 클릭하여 재스케일링을 트리거하고 대시보드 개요로 돌아가십시오. 재스케일링이 진행 중임을 알리는 '스케일링이 시작됨' 메시지가 페이지의 맨 위에 표시됩니다.스케일링이 완료되면 _배치 세부사항_ 분할창이 현재 사용량과 사용 가능한 스토리지에 대한 새로운 값을 표시하도록 업데이트됩니다.
...
![etcd 비밀번호 업데이트](./images/janusgraph-update-password.png "자동 비밀번호 생성기")
...
![IP 화이트리스트 작성](./images/janusgraph-whitelist-show.png "화이트리스트 필드")
