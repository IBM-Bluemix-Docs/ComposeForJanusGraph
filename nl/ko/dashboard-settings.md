...
비교적 작은 데이터 세트를 보유하고 있지만 복잡한 조회를 실행해야 하는 경우 스토리지 노드를 기본 크기인 5GB로 유지하고 더 나은 조회 성능을 얻을 수 있도록 엔진 노드의 메모리를 확장할 수 있습니다. Janus Graph Engine 노드에 메모리를 추가하려면 지원 센터에 문의하십시오.
